...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
    ...
    @Query("SELECT r FROM Reservation r WHERE r.teacher = :teacherEmail AND r.from_hour >= :from_hour ORDER BY r.from_hour")
    ...
    @Query("SELECT r FROM Reservation r WHERE r.reserved_by = :reservedBy AND r.from_hour >= :from_hour ORDER BY r.from_hour")
